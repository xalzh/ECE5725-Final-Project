...
class Camera(threading.Thread):
    ...
    def __init__(self, ready_event, cap, is_mode1, is_mode2, screen):
        # Initializes the Camera class with the necessary parameters and flags.
        super().__init__()
    ...
    def run(self):
        ...
        while not self.stop_event.is_set():
            ...
            if self.is_mode1 is True:
                ...
                if not ret:
                    break
                '''Apply MOSSE tracking to the frame and get the updated frame, ROI, selected ROI and whether the ROI 
                is lost '''
